...
import com.gilly.automation_framework.converters.Har2JmxConverter;
        ...
        if (testType.equalsIgnoreCase("WEB")) {
            switch (browserName.toUpperCase()) {
                case "CHROME":
                    ...
                    options.addArguments("test-type", "start-maximized", "no-default-browser-check", "--disable-extensions", "--disable-notifications");
